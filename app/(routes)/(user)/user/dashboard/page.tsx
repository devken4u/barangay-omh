      ...
      <SidebarInset className="h-screen overflow-hidden flex flex-col">
        ...
        <div className="px-4 flex items-center flex-col text-center">
          ...
          <p className="py-4 font-semibold">
            Access barangay services and updates with ease through the Barangay
            <br />
            174 Operations and Monitoring Hub User Panel — your gateway to
            <br />
            participation, information, and community support.
          </p>
